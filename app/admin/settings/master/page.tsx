        ...
        <div className="grid gap-4 xl:grid-cols-3">
          <article className="ds-radius-panel border border-slate-200/80 bg-slate-50/70 px-5 py-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="ds-text-xs-compact font-semibold ds-track-eyebrow text-slate-400">ORG MASTER</p>
          ...
          <article className="ds-radius-panel border border-slate-200/80 bg-slate-50/70 px-5 py-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="ds-text-xs-compact font-semibold ds-track-eyebrow text-slate-400">DEPARTMENT MASTER</p>
          ...
          <article className="ds-radius-panel border border-slate-200/80 bg-slate-50/70 px-5 py-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="ds-text-xs-compact font-semibold ds-track-eyebrow text-slate-400">REFERENCE</p>
