...
export default async function CaseDetailPage({ params }: CaseDetailPageProps) {
  ...
  return (
    <div className="dashboard-shell app-screen-canvas bg-[var(--dashboard-bg)] text-slate-900">
      <div className="page-frame page-frame--form content-card content-card--spacious text-center">
