...
export default async function MfaSetupPage({ searchParams }: { searchParams: Promise<{ callbackUrl?: string }> }) {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-10">
      <div className="w-full max-w-lg">
        ...
        <WebAuthnMfaCard mode="setup" callbackUrl={params.callbackUrl} />
      </div>
    </main>
  );
}
