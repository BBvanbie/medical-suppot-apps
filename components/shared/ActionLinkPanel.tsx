...
export function ActionLinkPanel({
  ...
  kickerClassName = "text-[11px] font-semibold tracking-[0.18em] text-slate-400",
  titleClassName = "mt-1 text-lg font-bold tracking-tight text-slate-900",
  badgeClassName = "rounded-full bg-slate-100 px-3 py-1 text-[11px] font-semibold text-slate-600",
  itemLabelClassName = "text-sm font-semibold text-slate-900",
  itemDescriptionClassName = "mt-1 text-[11px] leading-5 text-slate-500",
