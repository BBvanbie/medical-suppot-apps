  ...
  return (
    <>
      <aside
        ...
        className={`flex h-full flex-col border-r border-emerald-100/80 ds-bg-gradient-hospital-sidebar ds-shadow-side-soft ds-transition-width duration-300 ease-out ${
      ...
      >
          ...
          <div className="relative h-10">
            ...
            >
              <div className="flex h-full items-center whitespace-nowrap">
                <div>
                  <p className="ds-text-xs-compact font-semibold ds-track-eyebrow text-emerald-600">HOSPITAL</p>
            ...
            <button
              type="button"
              onClick={onToggle}
            className={`absolute top-1/2 inline-flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 ds-transition-sidebar-toggle duration-300 ease-out hover:border-emerald-200 hover:bg-emerald-50/70 hover:text-emerald-700 ${
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={`group relative mx-2 flex h-10 items-center rounded-xl transition ${
                      isActive
                        ? "bg-emerald-100/90 text-emerald-700 ds-shadow-inset-emerald"
        ...
        <div className="border-t border-emerald-100/70 px-4 py-4">
          <div
            ...
            aria-hidden={!expanded}
          >
            <div className="rounded-2xl bg-white/90 pb-0 ds-pl-sidebar-card pr-3 pt-3 ds-shadow-inset-emerald-faint">
