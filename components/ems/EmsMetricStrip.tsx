...
export function EmsMetricStrip({ title, items }: EmsMetricStripProps) {
  return (
    <MetricPanelFrame
      kicker={title}
      title="現況の読み取り"
      icon={<span className="rounded-full bg-blue-50 px-3 py-1 text-[10px] font-semibold text-blue-700">EMS</span>}
      className="rounded-[26px] bg-white/92 px-5 py-4 shadow-[0_18px_42px_-34px_rgba(15,23,42,0.22)]"
      iconClassName=""
