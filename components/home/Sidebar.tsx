        ...
        <div className="border-b border-slate-100 px-3 py-3">
          <div className="relative h-10">
            ...
            <button
              type="button"
              onClick={onToggle}
              className={`absolute top-1/2 inline-flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition-[left,right,transform,border-color,color] duration-300 ease-out hover:border-blue-200 hover:text-blue-700 ${
